...
<div class="row">
<div class="col-lg-6">
<span class="logo">NIT Checkon</span></div>
<?php
...
if (@$_GET['q'] == 6)
    echo 'class="active"';
?>><a href="dash.php?q=6">Add Quiz CSV</a></li>
      </ul>
          </div>
  </div>
</nav>
...
if (@$_GET['q'] == 6) {
            ...
            <label class="col-md-12 control-label" for=""></label>
            <div class="col-md-12"> 
                <form method="post" enctype="multipart/form-data" action="update.php?q=addcsv">
